package com.feetandinchmeasurements;

import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;
import com.feetandinchmeasuments.FeetAndInch.Feet;
import com.feetandinchmeasuments.FeetAndInch.Inches;


public class FeetAndInchTest {
    // FEET TESTS
    ...
    public void testFeetEquality_DifferentClass() {
        assertFalse(new Feet(1.0).equals(new Object()));
    }
    ...
    public void testInchesEquality_DifferentClass() {
        assertFalse(new Inches(1.0).equals(new Object()));
    }
